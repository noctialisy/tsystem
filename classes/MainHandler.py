...
class MainHandler:
    ...
    def help(self):
        ...
        print('  system_check_versions')
        print('    Check all versions of the currently installed software and shows possible upgrades')
        print('  system_update')
        print('    Updates the system software available through winget')
